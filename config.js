...
module.exports = {
    ...
    AUTOREP: process.env.AUTO_REPLY === undefined ? 'false' : process.env.AUTO_REPLY,
    ...
    BOTPLK: process.env.BOT_NAME === undefined ? 'LUSIFAR BOT' : process.env.BOT_NAME,
    ...
    MAHN: process.env.MAAN === undefined ? '94769370897,0' : process.env.MAAN, //dont change thise , if you change this some plugins created by me might not work for others or might have error ( bcoz this is a api key )
    BRANCH: 'master',
    HEROKU: {
